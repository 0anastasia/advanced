...
test('по массиву, потом по алфавиту name level', () => {
  const obj = {
...
test('по массиву, потом по алфавиту health level', () => {
  const obj = {
    name: 'мечник', health: 10, level: 2, attack: 80, defence: 40,
  };
...
test('по массиву, потом по алфавиту defence', () => {
  const obj = {
    name: 'мечник', health: 10, level: 2, attack: 80, defence: 40,
  };
